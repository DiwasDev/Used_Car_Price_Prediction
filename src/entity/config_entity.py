...
class DataSplitterConfig:
    training_file_path: str = os.path.join(training_pipeline_config.artifact_dir, DATA_INGESTION_DIR_NAME, DATA_INGESTION_INGESTED_DIR, TRAIN_FILE_NAME)
    testing_file_path: str = os.path.join(training_pipeline_config.artifact_dir, DATA_INGESTION_DIR_NAME, DATA_INGESTION_INGESTED_DIR, TEST_FILE_NAME)
...
class ModelEvaluationConfig:
    ...
    blob_prefix: str = MODEL_PUSHER_BLOB_PATH
